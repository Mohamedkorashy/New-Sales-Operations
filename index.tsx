...
const AppHeader: FC<AppHeaderProps> = ({ currentUser, onLogout, onNavigate }) => (
    <header>
        ...
        <div className="header-actions">
            {currentUser?.role === 'admin' && (
                <button onClick={() => onNavigate('users')} className="manage-users-button">
...
const UserManagementPage: FC<UserManagementPageProps> = ({ users, currentUser, addUser, deleteUser, onBackToDashboard }) => {
...
const App: FC = () => {
  ...
  const [view, setView] = useState<'login' | 'dashboard' | 'users'>('login');
  ...
  return (
    <div className="container">
      <AppHeader currentUser={currentUser} onLogout={handleLogout} onNavigate={setView} />
