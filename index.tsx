import React, { useState, useMemo, useCallback, ChangeEvent, DragEvent, FC } from 'react';
...
const App: FC = () => {
  ...
  return (
    <div className="container">
      <header>
        <h1><i className="fa-solid fa-building-user"></i> Capital Heights 1</h1>
          ...
          <>
            ...
            <div className="grid-container">
              {filteredAndSortedData.map(unit => (
                <UnitCard key={unit['Unit Code']} unit={unit} />
              ))}
            </div>
...
const UnitCard: FC<{ unit: UnitData }> = ({ unit }) => {
    return (
        <div className="unit-card">
            <div className="card-header">
                <span>{unit['Unit Code']}</span>
                <span>{unit['Building Type']}</span>
            </div>
            <div className="card-body">
                <div className="info-grid">
                    <div className="info-item">
                        <span className="label">Area</span>
                        <span className="value"><i className="fa-solid fa-ruler-combined"></i> {unit['Area (m²)']} m²</span>
                    </div>
                    <div className="info-item">
                        <span className="label">Floor</span>
                        <span className="value"><i className="fa-solid fa-stairs"></i> {unit.Floor}</span>
                    </div>
                </div>
            </div>
            <div className="card-footer">
                ...
                ) : <span /> /* Render empty span to preserve layout */}
